...
if __name__ == '__main__':
	...
	# looks sth like 'GIJRN3TLCRMSTTRR4QUZNE3J3C5AIO0YO5FAUELIG1ZFWOIK&v=20160413'
	venues = []
	for i in lat_lon:
		url = 'https://api.foursquare.com/v2/venues/search?ll=%.8f,%.8f&oauth_token=%s'%(i[0],i[1],token)
